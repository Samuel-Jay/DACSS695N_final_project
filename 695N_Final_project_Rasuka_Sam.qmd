...
>>>>>>> 39b0bbaacc6439eebc2916670bc1d1cb0ebafd63
...
V(genre_net)$color <- ifelse(V(genre_net)$genre, "lightblue", "pink")

V(genre_net)$shape <- ifelse(V(genre_net)$genre, "traingle", "circle")

E(genre_net)$color <- "black"
